...
public class QuizzController {
    ...
    public ResponseEntity<AnswerBody> isUserAnswerValid(@RequestBody AnswerBody body) {
        System.out.println("USER Answer : " + body.answer);
        System.out.println("ID Q : " + body.id);
        System.out.println("USER Email: " + body.email);
